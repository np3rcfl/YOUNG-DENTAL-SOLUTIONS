  ...
  return (
    <>
      ...
      <section className="min-h-[100dvh] flex items-center pt-24 pb-16">
        <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-[60%_40%] gap-12 items-center">
          <HomeAnimations>
            <div className="space-y-8">
              ...
              <h1 className="font-display text-5xl lg:text-7xl font-semibold text-navy leading-[1.1]">
                30 Years.
                <br />
                One Coach.
                <br />
          ...
          <div className="hidden lg:block">
            <div className="relative rounded-2xl overflow-hidden bg-cream aspect-[4/5]">
              <Image
                src="https://static.wixstatic.com/media/11062b_254deac88da14c43a32af02941ed7b30~mv2.jpeg"
      ...
      <section className="bg-navy py-10">
        <div className="max-w-4xl mx-auto px-6">
          <div className="grid grid-cols-3 divide-x divide-bg/10 text-center">
            {[
              { stat: "30+", label: "Years in Dental Industry" },
              { stat: "4", label: "Practice Services" },
              { stat: "SoCal", label: "Wide Service Area" },
            ].map(({ stat, label }) => (
              <div key={stat} className="px-6 py-4">
        ...
        <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="grid grid-cols-1 gap-4">
            {[
              ...
              <div
                key={text}
                className="flex items-start gap-4 p-5 bg-cream rounded-xl border border-navy/5"
              >
                <Icon size={22} weight="fill" className="text-gold mt-0.5 shrink-0" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {services.map(({ icon: Icon, title, tagline, description, href }) => (
              <Link
                key={href}
                href={href}
                className="group block p-8 bg-bg rounded-2xl border border-navy/5 hover:border-gold/30 hover:shadow-lg transition-all"
              >
          ...
          <div className="bg-navy rounded-3xl p-10 lg:p-16">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
              ...
              <div className="space-y-4">
                {[
                  {
                    them: "Sent a playbook for someone else&rsquo;s practice",
                  ...
                  >
                    <p
                      className="text-sm text-bg/40 line-through"
                      dangerouslySetInnerHTML={{ __html: them }}
                    />
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="space-y-6">
            {steps.map(({ num, title, desc }) => (
              <div
                key={num}
                className="flex gap-6 p-8 bg-bg rounded-2xl border border-navy/5"
              >
                <span className="font-display text-4xl font-semibold text-gold/30 shrink-0">
                  {num}
                </span>
                <div className="space-y-2">
