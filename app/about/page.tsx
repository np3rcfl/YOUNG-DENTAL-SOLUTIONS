        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-[55%_45%] gap-16 items-center">
            ...
            <div className="hidden lg:block">
              <div className="relative rounded-2xl overflow-hidden bg-cream aspect-[3/4]">
                <Image
        ...
        <div className="max-w-3xl mx-auto px-6 space-y-8">
          ...
          <div className="space-y-5 text-navy/70 leading-relaxed">
            ...
            <p>
              ...
              diagnosis. Too many playbooks designed for practices that didn&rsquo;t
              look anything like yours. Too many consultants who called once and
              disappeared.
            </p>
            <p>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {values.map(({ title, desc }) => (
              <div
                key={title}
                className="p-8 bg-cream rounded-2xl border border-navy/5 space-y-3"
              >
