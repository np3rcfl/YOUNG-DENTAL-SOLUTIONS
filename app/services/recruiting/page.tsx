        ...
        <div className="max-w-4xl mx-auto px-6 space-y-12">
          ...
          <div className="space-y-5">
            {process.map(({ num, title, desc }) => (
              <div key={num} className="flex gap-6 p-8 bg-bg rounded-2xl border border-navy/5">
                <span className="font-display text-4xl font-semibold text-gold/30 shrink-0">{num}</span>
      ...
      <section className="py-24">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div className="space-y-4">
              <div className="p-8 bg-navy rounded-2xl space-y-4">
